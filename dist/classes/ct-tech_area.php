...
function custom_taxonomy_tech_area() {

    $labels = array(
        'name'                       => _x( 'Tech Areas', 'Taxonomy General Name', 'sgm' ),
        'singular_name'              => _x( 'Tech Area', 'Taxonomy Singular Name', 'sgm' ),
    ...
    register_taxonomy( 'tech_area', array( 'sgm_tech' ), $args );

}
add_action( 'init', 'custom_taxonomy_tech_area', 0 );